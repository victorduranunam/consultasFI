...
<div class="container-fluid">
    ...
    <div class="row mb-4">
        <div class="col">
            ...
            <p class="text-muted">Apis para el servicio de la comunidad de la FI</p>
        </div>
    </div>
    ...
    <div class="row g-4">
        ...
        <div class="col-md-3">
            <div class="card shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <p class="text-muted">Gestión académica y grupos</p>
        ...
        <div class="col-md-3">
            <div class="card shadow-sm h-100">
                <div class="card-body text-center">
                    <div style="font-size:40px">📦</div>
                    <h5 class="mt-2">Inventarios de Laborarios</h5>
      ...
      <!-- Noticias -->
        <div class="col-md-3">
            <div class="card shadow-sm h-100">
                <div class="card-body text-center">
                    ...
                    <p class="text-muted">Gestión y consulta de noticias institucionales</p>
        ...
        <div class="col-md-3">
            <div class="card shadow-sm h-100">
                <div class="card-body text-center">
                    <div style="font-size:40px">🏫</div>
                    <h5 class="mt-2">Informacion de Salones</h5>
                    <p class="text-muted">Capacidad, recursos y características</p>
