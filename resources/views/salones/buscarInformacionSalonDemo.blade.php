...
@section('title', 'Recursos por Sal&oacute;n')
        ...
        <div class="col-12">
            ...
            <div class="card shadow-sm rounded-4">
                ...
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
                        Recursos asociados a un Sal&oacute;n
                    </h5>
                </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const baseUrl = "https://www.ingenieria.unam.mx/consultasfi/api/Salones/info";
        ...
        fetch(url)
            ...
            .then(data => {
                ...
                if(!data || data.length === 0){
                    ...
                    mensajeError.innerHTML = '<div class="alert alert-warning">No se encontraron recursos.</div>';
                    return;
                }
    ...
    function renderTabla(data){
        ...
        html += '<thead><tr><th>Nombre del Recurso</th><th>Cantidad</th></tr></thead><tbody>';

        data.forEach(item => {
            html += `<tr>
                <td>${item.nombre_recurso}</td>
                <td>${item.cantidad}</td>
