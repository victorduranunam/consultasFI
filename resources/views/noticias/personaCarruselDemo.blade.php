...
@section('title', 'Demo Noticias por Persona - Carrusel')

@section('header-title')
    Demo - Noticias por Persona (Carrusel)
@endsection
...
<div class="container-fluid py-4">
    ...
    <div class="card shadow-sm rounded-4">
        ...
        <div class="card-body">
            ...
            <div class="mb-4">
                <p>
                    Este demo muestra directamente el carrusel de noticias donde aparece una persona determinada.
...
&lt;script src="https://www.ingenieria.unam.mx/consultasfi/widgets/widget-noticias.js"&gt;&lt;/script&gt;
            ...
            <div style="overflow-x: hidden; max-width: 1200px; width: 90%; margin: 0 auto;">
                <div id="widget-noticias" 
                     data-endpoint="https://www.ingenieria.unam.mx/consultasfi/api/Noticias/persona?persona=rosalba&limit=10">
                </div>
            </div>
