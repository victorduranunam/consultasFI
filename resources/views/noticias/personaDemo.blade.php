...
@section('title', 'Demo Noticias por Persona')

@section('header-title')
    Demo - Noticias por Persona
@endsection
...
document.getElementById('btnConsultar').addEventListener('click', function(){
    ...
    fetch(`/consultasfi/api/Noticias/persona?persona=${persona}&limit=${limit}&offset=${offset}`)
        .then(r => r.json())
        .then(data => {
            ...
            data.data.forEach(noticia => {
                ...
                li.innerHTML = `
                    ...
                    <small>
                        Autor: ${noticia.autor} |
                        Fot&oacute;grafo: ${noticia.fotografo} |
