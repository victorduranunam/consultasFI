                ...
                <div class="card-body">
                    ...
                    <form id="formEdificio">
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <label class="form-label">Letra del edificio</label>
                                <input type="text"
                                       id="letra"
                                       class="form-control"
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const baseUrl =
    "https://www.ingenieria.unam.mx/consultasfi/api/Inventarios/edificio";
    ...
    function validarFormulario(){
        btnConsultar.disabled = letraInput.value.trim() === '';
    }

    letraInput.addEventListener('input', validarFormulario);
    ...
    function consultar(){
        ...
        const url = `${baseUrl}?letra=${encodeURIComponent(letra)}&page=${currentPage}&per_page=${perPage}`;
