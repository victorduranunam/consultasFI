...
@section('title', 'Demo Estad&iacute;sticas por Laboratorio')
        ...
        <div class="col-12">
            ...
            <div class="card shadow-sm rounded-4">
                ...
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
                        Estad&iacute;sticas de Inventario por Laboratorio
                    </h5>
                </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function renderTabla(data){
        ...
        data.forEach(obj=>{
            ...
            tdLab.textContent = obj.laboratorio;
            tr.appendChild(tdLab);

            const tdTotal = document.createElement('td');
            tdTotal.textContent = obj.total_equipos;
