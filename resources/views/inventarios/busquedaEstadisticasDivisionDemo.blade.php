...
@section('title', 'Estadísticas por División')
        ...
        <div class="col-12">
            ...
            <div class="card shadow-sm rounded-4">
                ...
                <div class="card-header bg-primary text-white">
                    <h5 class="mb-0">
                        Estad&iacute;sticas de Inventario por Divisi&oacute;n
                    </h5>
                </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const baseUrl =
    "https://www.ingenieria.unam.mx/consultasfi/api/Inventarios/estadisticas/division";

    const columnasPermitidas = ['descripcion','total'];
    ...
    function validarFormulario(){
        btnConsultar.disabled = divisionInput.value.trim() === '';
    }

    divisionInput.addEventListener('input', validarFormulario);
    ...
    function consultar(){
        ...
        const url = `${baseUrl}?division=${encodeURIComponent(division)}&page=${currentPage}&per_page=${perPage}`;
    ...
    function renderTabla(data){
        ...
        columnasPermitidas.forEach(col=>{
            ...
            th.textContent = col === 'descripcion'
                ? 'Descripci&oacute;n'
                : 'Total';
        ...
        data.forEach(obj=>{
            ...
            tdDescripcion.textContent = obj.descripcion;
