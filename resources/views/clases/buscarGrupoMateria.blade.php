            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap justify-content-between align-items-center mb-3">
                        <h3 class="mb-2 mb-md-0">&#128196; Microservicio: Consulta de grupos por materia</h3>
                        <div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9">gruposPorMateria</div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9">
                            <code>https://www.ingenieria.unam.mx/consultasfi/api/Clases/materias/grupos</code>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9">
                            <p class="mb-2">
                                Este microservicio permite consultar los grupos asignados a una materia espec&iacute;fica,
                                ya sea proporcionando la clave o el nombre de la asignatura.
                            </p>
                            <p class="mb-0">
                                La informaci&oacute;n devuelta incluye datos del grupo, modalidad, estatus,
                                informaci&oacute;n del profesor asignado y el total de alumnos inscritos.
                            </p>
                        </div>
                    </div>
                            ...
                            <table class="table table-bordered table-sm align-middle">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>string</td>
                                        <td>S&iacute;</td>
                                        <td>Clave o nombre (completo o parcial) de la materia</td>
                                    </tr>
                                    <tr>
                                        <td>limit</td>
                                        <td>int</td>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9">
                            <ul class="mb-0">
                                ...
                                <li>La b&uacute;squeda se realiza por coincidencia parcial utilizando ILIKE.</li>
                                <li>Los resultados se ordenan por nombre de asignatura y n&uacute;mero de grupo.</li>
                                <li>Se devuelve el total de alumnos inscritos por grupo.</li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-9">
                            <ul class="mb-0">
                                <li>Consultar los grupos disponibles de una materia espec&iacute;fica.</li>
                                <li>Verificar el profesor asignado a cada grupo.</li>
                                <li>Obtener el total de alumnos inscritos en cada grupo.</li>
                                <li>Integrar la informaci&oacute;n en sistemas de coordinaci&oacute;n acad&eacute;mica.</li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="{{ route('buscarGrupoMateriaDemo') }}" class="btn btn-primary">
        ...
        <div class="col-12">
            <div class="card shadow-sm">
                <div class="card-body">
                    ...
                    <div class="d-flex justify-content-center">
                        <a href="https://www.ingenieria.unam.mx/consultasfi/downloads/buscarGrupoMateria.rar"
