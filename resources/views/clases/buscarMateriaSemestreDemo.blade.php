...
@section('title', 'Materias por Semestre')
        ...
        <div class="col-12">
            ...
            <div class="card shadow-sm rounded-4">
                ...
                <div class="card-header bg-primary text-white d-flex align-items-center">
                    <h5 class="mb-0"> Consulta de Materias por Semestre (Microservicio)</h5>
                </div>
                    ...
                    <form id="formMaterias">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control busqueda" id="division">
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">Semestre</label>
                                <input type="number" class="form-control busqueda" id="semestre" min="1" max="12">
                            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const baseUrl = "https://www.ingenieria.unam.mx/consultasfi/api/Clases/materias/semestre";
    ...
    const camposBusqueda = ['division','semestre'];

    /* ==========================
       ACTIVAR / DESACTIVAR BOT&Oacute;N
    ========================== */
    function actualizarBoton(){
        ...
        btnBuscar.disabled = !(division !== '' && semestre !== '');
    }
    ...
    form.addEventListener('submit', function(e){
        ...
        if(division === '' || semestre === ''){
            ...
            resultadoRaw.textContent = "Debe proporcionar divisi&oacute;n y semestre.";
            return;
        }
