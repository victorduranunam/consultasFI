...
@section('title', 'Buscar Grupos por Profesor')
            ...
            <div class="card shadow-sm rounded-4">
                ...
                <div class="card-header bg-primary text-white d-flex align-items-center">
                    <h5 class="mb-0">
                        ...
                        Consulta de Grupos por Profesor (Microservicio)
                    </h5>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form id="formGrupos">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                <label class="form-label">N&uacute;mero de trabajador</label>
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="email" class="form-control busqueda" id="correo">
                            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const baseUrl = "https://www.ingenieria.unam.mx/consultasfi/api/Clases/maestros/grupos";
    ...
    const camposBusqueda = ['num_trabajador','nombre','correo'];
