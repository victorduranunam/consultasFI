...
@section('title', 'Materias por Division')
        ...
        <div class="col-12">
            ...
            <div class="card shadow-sm rounded-4">
                ...
                <div class="card-header bg-primary text-white d-flex align-items-center">
                    <h5 class="mb-0"> Consulta de Materias por Divisi&oacute;n (Microservicio)</h5>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form id="formDivision">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label class="form-label">Divisi&oacute;n (nombre o alias)</label>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const baseUrl = "https://www.ingenieria.unam.mx/consultasfi/api/Clases/materias/division";
    ...
    form.addEventListener('submit', function(e){
        ...
        if(params.toString().trim() === ''){
            ...
            resultadoRaw.textContent = "Debe ingresar una división para consultar.";
            return;
        }
