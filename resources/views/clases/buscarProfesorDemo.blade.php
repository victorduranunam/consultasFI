@extends('layouts.app') {{-- o el layout que ya uses --}}
        ...
        <div class="col-12">
            ...
            <div class="card shadow-sm rounded-4">
                ...
                <div class="card-header bg-primary text-white d-flex align-items-center">
                    <h5 class="mb-0"> Consulta de Profesor (Microservicio)</h5>
                </div>
                    ...
                    <form id="formProfesor">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control busqueda" id="ape_paterno">
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">Apellido materno</label>
                                <input type="text" class="form-control busqueda" id="ape_materno">
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control busqueda" id="num_trabajador">
                            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const baseUrl = "https://www.ingenieria.unam.mx/consultasfi/api/Clases/buscarProfesor";
    ...
    const camposBusqueda = ['nombre','ape_paterno','ape_materno','correo_personal','num_trabajador'];

    // Función para habilitar/deshabilitar el botón según campos llenos
    function actualizarBoton(){
        const hayDato = camposBusqueda.some(id => document.getElementById(id).value.trim() !== '');
        btnBuscar.disabled = !hayDato;
    }

    // Monitorear cambios en campos de búsqueda
    document.querySelectorAll('.busqueda').forEach(el=>{
        el.addEventListener('input', actualizarBoton);
    });

    // Llamamos al inicio para establecer el estado del botón
    actualizarBoton();
    ...
    form.addEventListener('submit', function(e){
        ...
        // Verificamos que haya al menos un parámetro
