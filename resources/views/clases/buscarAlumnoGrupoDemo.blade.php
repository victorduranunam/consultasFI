...
@section('title', 'Alumnos por Grupo y Asignatura')
        ...
        <div class="col-12">
            ...
            <div class="card shadow-sm rounded-4">
                ...
                <div class="card-header bg-primary text-white d-flex align-items-center">
                    <h5 class="mb-0"> Consulta de Alumnos por Grupo y Asignatura (Microservicio)</h5>
                </div>

                <div class="card-body">

                    {{-- FORMULARIO --}}
                    <form id="formAlumnosGrupo">

                        <div class="row g-3">

                            <div class="col-md-4">
                                <label class="form-label">Clave de asignatura</label>
                                <input type="text" class="form-control busqueda" id="clave_asignatura">
                            </div>

                            <div class="col-md-4">
                                <label class="form-label">N&uacute;mero de grupo</label>
                                <input type="text" class="form-control busqueda" id="numero_grupo">
                            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const baseUrl = "https://www.ingenieria.unam.mx/consultasfi/api/Clases/alumnos/grupo-asignatura";

    const form = document.getElementById('formAlumnosGrupo');
    ...
    const camposBusqueda = ['clave_asignatura','numero_grupo'];
    ...
    form.addEventListener('submit', function(e){
        ...
        const clave = document.getElementById('clave_asignatura').value.trim();
        const grupo = document.getElementById('numero_grupo').value.trim();

        if(clave === '' || grupo === ''){
            loader.classList.add('d-none');
            resultadoRaw.classList.remove('d-none');
            resultadoRaw.textContent = "Debe proporcionar clave_asignatura y numero_grupo.";
            return;
        }

        const params = new URLSearchParams();
        params.append('clave_asignatura', clave);
        params.append('numero_grupo', grupo);
        params.append('limit', document.getElementById('limit').value);
        params.append('offset', document.getElementById('offset').value);
