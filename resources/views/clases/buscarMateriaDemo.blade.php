        ...
        <div class="col-12">
            ...
            <div class="card shadow-sm rounded-4">
                ...
                <div class="card-header bg-primary text-white d-flex align-items-center">
                    <h5 class="mb-0"> Consulta de Materia (Microservicio)</h5>
                </div>
                    ...
                    <form id="formMateria">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control busqueda" id="clave">
                            </div>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" class="form-control" id="limit" value="50" min="1" max="100">
                            </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // ? ENDPOINT CORRECTO
    const baseUrl = "https://www.ingenieria.unam.mx/consultasfi/api/Clases/materias/buscar";
    ...
    const camposBusqueda = ['clave','nombre'];
