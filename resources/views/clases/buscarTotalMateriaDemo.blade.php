...
@section('title', 'Totales de Alumnos por Materia')
        ...
        <div class="col-12">
            ...
            <div class="card shadow-sm rounded-4">
                ...
                <div class="card-header bg-primary text-white d-flex align-items-center">
                    <h5 class="mb-0"> Consulta de Totales de Alumnos por Materia (Microservicio)</h5>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form id="formMateria">
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                <label class="form-label">Materia (clave o nombre)</label>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const baseUrl = "https://www.ingenieria.unam.mx/consultasfi/api/Clases/alumnos/totales-por-materia";
    ...
    form.addEventListener('submit', function(e){
        ...
        if(materia === ''){
            ...
            resultadoRaw.textContent = "Debe proporcionar la clave o el nombre de la materia.";
            return;
        }
